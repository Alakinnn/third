export const customers = [{id: 1, name: 'Alice', address: '101 Main Street'},
  {id: 2, name: 'Bob', address: '303 Sub Street'}, 
  {id: 3, name: "Duong", address: "s3978452" + ' RMIT'}]; 
export const orders = [{customer_id: 1, product_id: 1, quantity: 2},
{customer_id: 1, product_id: 2, quantity: 3}, 
{customer_id: 3, product_id: 1, quantity: 5}, 
{customer_id: 3, product_id: 3, quantity: 2}]; 
export const products = [{id: 1, name: 'Laptop', price: 500.0, sell_off: true, percent: 10.0}, 
